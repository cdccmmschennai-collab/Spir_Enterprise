...
async def ensure_schema() -> None:
    ...
    ddl = [
        ...
        # currency_rates stores the frozen exchange-rate snapshot used by that extraction.
        "ALTER TABLE extraction_history ADD COLUMN IF NOT EXISTS currency_rates JSON",
