  ...
  return (
    <SidebarLayout>
      <div className="mx-auto max-w-4xl space-y-6 p-4 sm:p-6 lg:p-8">
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Data Tables</h1>
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 py-16 text-center">
          ...
          <h3 className="mt-4 text-sm font-semibold text-slate-700 dark:text-slate-300">Coming soon</h3>
